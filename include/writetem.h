...
typedef int (*wtTAGHANDLER_t)( wtSTREAM_t *stream, wtTAG_t** tags, 
		                           wtGENERIC_t data, char* other );
...
int wtConditionalHandler( wtSTREAM_t *stream, wtTAG_t** tags, 
		                      wtGENERIC_t data, char* other );

int wtConditionalDisplayHandler( wtSTREAM_t *stream, wtTAG_t** tags, 
		                             wtGENERIC_t data, char* other );
